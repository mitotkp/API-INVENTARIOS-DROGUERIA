...
export class  inventoryQuerys {
    ...
    static insertProductLine = `
        ...
        (FECHA, CODARTICULO, TALLA, COLOR, IDTARIFAV, PRECIOUNITARIO, HORACONTEO, CODVENDEDOR, UNIDADES, UNIDADESOLICITADAS, IDCONTEO)
        VALUES 
        (CAST(GETDATE() AS DATE), @CODARTICULO, @TALLA, @COLOR, @IDTARIFAV, @PRECIOUNITARIO, CONVERT(TIME, GETDATE()), @CODVENDEDOR, @UNIDADES, @UNIDADESOLICITADAS,  @IDCONTEO)
    `; 
